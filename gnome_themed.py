...
class GnomeThemed(Gtk.Window):
    def __init__(self):
        ...
        self.table1L.set_row_spacings(5)
        self.table1R.set_row_spacings(5)
        ...
        self.table1L.attach(self.selection1.color_sel, 2, 3, 2, 3, xpadding=10)
        ...
        self.table1L.attach(self.selection2.color_sel, 2, 3, 5, 6, xpadding=10)
        ...
        self.table1R.attach(self.selection3.color_sel, 2, 3, 2, 3, xpadding=10)
        ...
        self.table1R.attach(self.selection4.color_sel, 2, 3, 5, 6, xpadding=10)
